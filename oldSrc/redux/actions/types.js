...
export const GET_CONTENT_FIELDS = 'GET_CONTENT_FIELDS';

// modal
export const SET_MODAL = 'SET_MODAL';
export const REQUESTING_MODAL_DATA = 'REQUESTING_MODAL_DATA';
export const RECEIVED_MODAL_DATA = 'RECEIVED_MODAL_DATA';
export const SET_SENDING_TRUE = 'SET_SENDING_TRUE';
export const SET_SENDING_FALSE = 'SET_SENDING_FALSE';